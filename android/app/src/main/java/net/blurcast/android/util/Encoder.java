...
public class Encoder {
    ...
    /** encodes n-bytes of data **/
    public static byte[] encode_bytes(char[] u) {
        CharBuffer charBuffer = CharBuffer.wrap(u);
    ...
    /** convert from a 32-bit signed int to a 2-byte array */
    public static byte[] encode_char (int u) {
        byte[] array = new byte[2];
    ...
    /** convert from a 64-bit unsigned long to a 2-byte array */
    public static byte[] encode_char (long u) {
        byte[] array = new byte[2];
    ...
    public static byte[] encode_long_to_3_bytes(long u) {
        byte[] array = new byte[3];

        array[0] = (byte) ((u >> 16) & 0xFF);
        array[1] = (byte) ((u >> 8) & 0xFF);
        array[2] = (byte) (u & 0xFF);
